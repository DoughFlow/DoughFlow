...
API_key = "957a2db3704345e18008d5bc61191456"
LIST_file = "list_seven.txt"

def request_data(indicator, API_key):
    res = requests.get(f"https://api.twelvedata.com/sma?apikey={API_key}&interval=1day&symbol={indicator}&end_date=2024-05-06 00:00:00&start_date=2019-05-06 00:00:00&format=JSON")
    return res.json()
