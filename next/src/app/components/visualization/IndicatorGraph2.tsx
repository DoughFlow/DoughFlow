...
const IndicatorGraph = ({ticker, date, indicator, height, width}: {ticker: string, date: string, indicator: string, height: number, width: number}) => {
