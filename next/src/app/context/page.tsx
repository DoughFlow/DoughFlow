...
const Context = () => {
    const { stocks, initStock, updateStock, removeStock, renderPrevious } = useStocks();
    useEffect(() => {
          initStock("aapl");
    }, []);
        ...
        <div className=''>
            ...
            {stocks.map((stock, index) => (
              <div key={index}>
                ...
                <div onClick={() => removeStock(index)}>remove</div>
              </div>
            ))}

            <div onClick={() => addStock(0)}>add stock in index 0</div>
